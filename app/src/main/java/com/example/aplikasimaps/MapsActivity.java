...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //fusedLocationProviderApi = LocationServices.getfusedLocationProviderApi(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-6.982950, 106.837074);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Lokasi Saya"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    }

    @Override
    public void Koordinat(Location location) {
